...
export default (props: baseIconProps) => {
    ...
    return (
        <>
            <svg onClick={onClick} className={STYLE.svg_container} width={width || BASE_WIDTH} height={height || BASE_HEIGHT} style={{...style}} fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
